...
def json_scrape_s_bills(cong, num,n,x):
    ...
    if os.path.isfile(f'/Users/Hugo/Desktop/Research/Research/Bills/{cong}_s_{num}_general.json') == True:
        ...
        os.remove(os.path.isfile(f'/Users/Hugo/Desktop/Research/Research/Bills/{cong}_s_{num}_general.json'))
        print("finished")
        return
...
def json_scrape_hjres_bills(cong, num, n, x):
    ...
    writeFile =open(os.path.join('/Users/Hugo/Desktop/Research/Research/Bills', f'{cong}_hjres_{num}_general.json'), 'w')
    writeFile.write(response.text)
    writeFile.close()
    n=1
    if os.path.isfile(f'/Users/Hugo/Desktop/Research/Research/Bills/{cong}_hjres_{num}_general.json') == True:
        print("complete")
        n+=1
        if n==975:
            time.sleep(3660)
...
json_scrape_hjres_bills(111, 1, 1, 9)
